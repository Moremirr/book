...
const StageNo = () => {
    return (
        <div className="flex flex-col items-center justify-center w-full h-full">
            <div className="text-md md:text-lg text-white/90 max-w-lg text-justify leading-relaxed space-y-4 overflow-y-auto max-h-[60vh] pr-2 scrollbar-thin scrollbar-thumb-white/20">
                <p>
